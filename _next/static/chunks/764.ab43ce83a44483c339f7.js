    ...
    9742: function (t, r) {
      ...
      (r.byteLength = function (t) {
        ...
        (r.fromByteArray = function (t) {
          for (
            var r, n = t.length, o = n % 3, i = [], f = 16383, u = 0, s = n - o;
            u < s;
            u += f
          )
    ...
    8764: function (t, r, e) {
      ...
      function h(t, r, e) {
        ...
        var o = (function (t) {
          ...
          if (void 0 !== t.length)
            return "number" !== typeof t.length || q(t.length) ? u(0) : p(t);
      ...
      function p(t) {
        for (
          var r = t.length < 0 ? 0 : 0 | y(t.length), e = u(r), n = 0;
          n < r;
          n += 1
        )
          e[n] = 255 & t[n];
      ...
      (s.prototype.slice = function (t, r) {
        ...
        (s.prototype.readUInt16LE = function (t, r) {
          return (
            (t >>>= 0), r || x(t, 2, this.length), this[t] | (this[t + 1] << 8)
          );
        }),
        (s.prototype.readUInt16BE = function (t, r) {
          return (
            (t >>>= 0), r || x(t, 2, this.length), (this[t] << 8) | this[t + 1]
          );
        }),
        ...
        (s.prototype.readFloatLE = function (t, r) {
          return (
            (t >>>= 0), r || x(t, 4, this.length), o.read(this, t, !0, 23, 4)
          );
        }),
        (s.prototype.readFloatBE = function (t, r) {
          return (
            (t >>>= 0), r || x(t, 4, this.length), o.read(this, t, !1, 23, 4)
          );
        }),
        (s.prototype.readDoubleLE = function (t, r) {
          return (
            (t >>>= 0), r || x(t, 8, this.length), o.read(this, t, !0, 52, 8)
          );
        }),
        (s.prototype.readDoubleBE = function (t, r) {
          return (
            (t >>>= 0), r || x(t, 8, this.length), o.read(this, t, !1, 52, 8)
          );
        }),
